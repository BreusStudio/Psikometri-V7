...
export async function POST(req: Request) {
  try {
    ...
    sqlScript += `-- Allow SELECT for any public user (anonymous/authenticated)\n`;
    ...
    sqlScript += `-- Allow INSERT for any public user (anonymous/authenticated)\n`;
    ...
    sqlScript += `-- Allow UPDATE for any public user (anonymous/authenticated)\n`;
    ...
    sqlScript += `-- Allow DELETE for any public user (anonymous/authenticated)\n`;

...
import { handleAddPurchase, handleArchivePurchase, handleDeletePurchaseCascade } from './commerceOperations';
...
export class PsychometricStore {
  ...
  public addPurchase(p: Purchase): void {
    handleAddPurchase(this.state, p, (v) => this.saveVoucher(v));
    this.saveToStorage();
    this.notifyListeners();
  }
  ...
  public archivePurchase(idOrCode: string): boolean {
    const res = handleArchivePurchase(this.state, idOrCode);
    this.saveToStorage();
    this.notifyListeners();
    return res;
  }
  ...
  public deletePurchaseCascade(idOrCode: string): boolean {
    const res = handleDeletePurchaseCascade(this.state, idOrCode);
    this.saveToStorage();
    this.notifyListeners();
    return res;
  }
